...
class ContentViewTests(TestCase):
    def setUp(self):
        ...
        self.c1 = Content.objects.create(title="Carl's First Blog",
                                         sub_title="first",
                                         author="Carl James",
                                         location="Bloomington, IN",
                                         pub_date=self.now - datetime.timedelta(days=30),
                                         featured_image="https://live.staticflickr.com/65535/50630286192_137fed66d0_m.jpg",
                                         ...
                                         content="<p>With conferences, retreats and in-person "
                                                 ...
                                                 "mix of channels</p>",)
        self.c1.save()
        self.c2 = Content.objects.create(title="Carl's Second Blog",
        ...
        self.c2.save()
        self.c3 = Content.objects.create(title="Carl's Third Blog",
                                         sub_title="third",
                                         author="Carl James",
                                         location="Bloomington, IN",
                                         ...
                                         content="<p>Manufacturers are introducing face masks "
                                                 ...
                                                 "the face. ",)
        self.c3.save()
        self.c4 = Content.objects.create(title="Carl's Fourth Blog",
                                         sub_title="fourth",
                                         author="Carl James",
                                         location="Bloomington, IN",
                                         ...
                                         content="<p>The law that enabled the rise of social "
                                                 ...
                                                 "on their sites.<.p>", )
        self.c4.save()
        self.c5 = Content.objects.create(title="Carl's Fifth Blog",
                                         sub_title="fifth",
                                         author="Carl James",
                                         location="Bloomington, IN",
        ...
        self.c5.save()
        self.c6 = Content.objects.create(title="Carl's Sixth Blog",
                                         sub_title="third",
                                         author="Carl James",
                                         location="Bloomington, IN",
